...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update grok client to the latest version",
	Long: `Check for updates and download the latest version of grok client.
This command will:
...
func runUpdate(_ *cobra.Command, _ []string) error {
	...
	fmt.Printf("You can verify the update by running: grok version\n")
